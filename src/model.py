...
class ResidualBlock(Layer):
    ...
    def __init__(self):
        ...
        self.conv_1 = layers.Conv2D(filters=64, kernel_size=(
            3, 3), strides=(1, 1), padding="same")
        self.bn_1 = layers.BatchNormalization()
        self.prelu_1 = layers.PReLU()

        self.conv_2 = layers.Conv2D(filters=64, kernel_size=(
            3, 3), strides=(1, 1), padding="same")
...
class Generator(tf.keras.Model):
    ...
    def __init__(self):
        ...
        # k9n64s1
        self.conv_1 = layers.Conv2D(filters=64, kernel_size=(9, 9), strides=(1, 1), padding="same", use_bias=False)
        self.act_1 = layers.PReLU()

        # residual blocks
        self.residual_blocks = [ResidualBlock()
                                for i in range(config.NUMRESBLOCKS)]
        ...
        # k3n256s1
        self.conv_3 = layers.Conv2D(filters=256, kernel_size=(
            3, 3), strides=(1, 1), padding="same")
        self.convT_1 = layers.Conv2DTranspose(filters=256, kernel_size=(
            3, 3), strides=(2, 2), padding="same", use_bias=False)
        self.act_2 = layers.PReLU()

        # k3n256s1
        self.conv_4 = layers.Conv2D(filters=256, kernel_size=(
            3, 3), strides=(1, 1), padding="same")
        self.convT_1 = layers.Conv2DTranspose(filters=256, kernel_size=(
            3, 3), strides=(2, 2), padding="same", use_bias=False)
        ...
        # k9n3s1
        self.conv_5 = layers.Conv2D(filters=3, kernel_size=(
            9, 9), strides=(1, 1), padding="same", use_bias=False)
...
class Discriminator(tf.keras.Model):
    ...
    def __init__(self):
        ...
        # k3n128s1
        self.conv_3 = layers.Conv2D(filters=128, kernel_size=(
            3, 3), strides=(1, 1), padding="same")
        self.bn_2 = layers.BatchNormalization()
        self.act_3 = layers.LeakyReLU()

        # k3n128s2
        self.conv_4 = layers.Conv2D(filters=128, kernel_size=(
            3, 3), strides=(2, 2), padding="same")
        self.bn_3 = layers.BatchNormalization()
        self.act_4 = layers.LeakyReLU()

        # k3n256s1
        self.conv_5 = layers.Conv2D(filters=256, kernel_size=(
            3, 3), strides=(1, 1), padding="same")
        self.bn_4 = layers.BatchNormalization()
        self.act_5 = layers.LeakyReLU()

        # k3n256s2
        self.conv_6 = layers.Conv2D(filters=256, kernel_size=(
            3, 3), strides=(2, 2), padding="same")
        self.bn_5 = layers.BatchNormalization()
        self.act_6 = layers.LeakyReLU()

        # k3n512s1
        self.conv_7 = layers.Conv2D(filters=512, kernel_size=(
            3, 3), strides=(1, 1), padding="same")
        self.bn_6 = layers.BatchNormalization()
        self.act_7 = layers.LeakyReLU()

        # k3n512s2
        self.conv_8 = layers.Conv2D(filters=512, kernel_size=(
            3, 3), strides=(2, 2), padding="same")
